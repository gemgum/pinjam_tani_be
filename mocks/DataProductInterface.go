...
// DataProductInterface is an autogenerated mock type for the DataProductInterface type
type DataProductInterface struct {
	mock.Mock
}

// DecreaseProduct provides a mock function with given fields: id, sum
func (_m *DataProductInterface) DecreaseProduct(id uint, sum uint) error {
...
func (_m *DataProductInterface) Delete(id uint) error {
	ret := _m.Called(id)
...
func (_m *DataProductInterface) GetAll(page int, pageSize int) ([]products.ProductsEntity, error) {
...
func (_m *DataProductInterface) GetProductById(id uint) (*products.ProductsEntity, error) {
	ret := _m.Called(id)
...
func (_m *DataProductInterface) GetProductByName(productName string) ([]products.ProductsEntity, error) {
...
func (_m *DataProductInterface) GetUserProducts(userID uint, page int, pageSize int) ([]products.ProductsEntity, error) {
...
func (_m *DataProductInterface) Insert(product products.ProductsEntity) (uint, error) {
...
func (_m *DataProductInterface) SelectById(id uint) (*products.ProductsEntity, error) {
	ret := _m.Called(id)
...
func (_m *DataProductInterface) Update(id uint, product products.ProductsEntity) error {
...
func NewDataProductInterface(t interface {
	mock.TestingT
	Cleanup(func())
