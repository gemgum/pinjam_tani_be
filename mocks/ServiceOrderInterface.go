...
func (_m *ServiceOrderInterface) AddOrderItems(orderItemData order.OrderItemEntity, orderStatusData order.OrderStatusEntity) (uint, uint, error) {
...
func (_m *ServiceOrderInterface) AddOrderStatuses(orderData order.OrderStatusEntity) error {
...
func (_m *ServiceOrderInterface) GetOrderQtyProduct(id uint) (uint, error) {
	ret := _m.Called(id)
...
func (_m *ServiceOrderInterface) GetOrders(userID uint) (order.ListOrderItemEntity, error) {
...
// ProccesOrderPayment provides a mock function with given fields: userMidtransData
func (_m *ServiceOrderInterface) ProccesOrderPayment(userMidtransData order.MidatransDataRequestEntity) (order.MidtransDataEntity, error) {
	ret := _m.Called(userMidtransData)

	if len(ret) == 0 {
		panic("no return value specified for ProccesOrderPayment")
	}

	var r0 order.MidtransDataEntity
	var r1 error
	if rf, ok := ret.Get(0).(func(order.MidatransDataRequestEntity) (order.MidtransDataEntity, error)); ok {
		return rf(userMidtransData)
	}
	if rf, ok := ret.Get(0).(func(order.MidatransDataRequestEntity) order.MidtransDataEntity); ok {
		r0 = rf(userMidtransData)
	} else {
		r0 = ret.Get(0).(order.MidtransDataEntity)
	}

	if rf, ok := ret.Get(1).(func(order.MidatransDataRequestEntity) error); ok {
		r1 = rf(userMidtransData)
	} else {
		r1 = ret.Error(1)
	}
